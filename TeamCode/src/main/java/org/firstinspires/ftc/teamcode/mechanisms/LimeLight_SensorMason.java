...
import org.firstinspires.ftc.teamcode.CompetitionTeleOpBlueMason;
...
/**
 * LIME LIGHT SENSOR MASON - Refactored vision sensor class.
 * Manages Limelight 3A and AprilTag detections for goal alignment and distance.
 */
public class LimeLight_SensorMason {
    ...
    public LimeLight_SensorMason(HardwareMap hardwareMap, Telemetry telemetry) {
        // Initialization handled via init methods below for flexibility
    }
